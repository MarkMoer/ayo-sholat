...
const Home = () => {
  ...
  return (
    <section className="font-poppins">
      {/* Navbar */}
      <div className="flex flex-row p-4 justify-between gap-2 bg-secondary md:px-32">
        <a href="/" className="font-bold text-primary text-xl p-1">
          emefka
        </a>
        <div className="flex md:order-2 gap-3 items-center">
          ...
          <a
            ...
            target="_blank"
            className="w-9 h-9 mr-3 rounded-full flex justify-center items-center border border-primary"
          >
            <svg
              role="img"
              width="20"
